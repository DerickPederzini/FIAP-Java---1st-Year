...
public class exerc01_metodos {
    static Scanner in = new Scanner(System.in);
    static String nome;

    public static void main(String[] args) {
        double calculoMedia = 0;
        int acomodacao = 0, dias= 0;
        ...
        calculoEstadia(acomodacao, dias);

        calculoMedia = calculoEstadia(acomodacao, dias);

        payment(calculoMedia);

    }

    public static double calculoEstadia(int acomodacao, int dias){
        int valordiaria =0 ;
    ...
    public static void payment(double calculoMedia){
        ...
        if (typePay == 'V'){
            ...
            System.out.println("Parabéns "+nome);
            System.out.println("Valor final do pagamento: "+calculoMedia);
        }
